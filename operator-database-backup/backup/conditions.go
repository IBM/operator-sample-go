...
// Note: Status of BACKUP_RESOURCE_FOUND can only be False; otherwise there is no condition
const CONDITION_TYPE_BACKUP_RESOURCE_FOUND = "BackupResourceFound"
const CONDITION_REASON_BACKUP_RESOURCE_FOUND = "BackupResourceFound"
const CONDITION_MESSAGE_BACKUP_RESOURCE_FOUND = "Backup resource can not be found"

func setConditionBackupResourceFound() error {
	fmt.Println("Adding BACKUP_RESOURCE_FOUND condition ...")
	return utilities.AppendCondition(applicationContext, kubernetesClient, &databaseBackupResource, CONDITION_TYPE_BACKUP_RESOURCE_FOUND, CONDITION_STATUS_FALSE,
		CONDITION_REASON_BACKUP_RESOURCE_FOUND, CONDITION_MESSAGE_BACKUP_RESOURCE_FOUND)
}
