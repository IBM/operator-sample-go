...
func setConditionCOSAPIKeyDefined(ctx context.Context, controllerRuntimeClient client.Client, object client.Object) error {
	fmt.Println("Adding COS_API_KEY_DEFINED condition ...")
	return utilities.AppendCondition(ctx, controllerRuntimeClient, object, CONDITION_TYPE_COS_API_KEY_DEFINED, CONDITION_STATUS_FALSE,
...
func setConditionCOSServiceInstanceIdNotDefined(ctx context.Context, controllerRuntimeClient client.Client, object client.Object) error {
	fmt.Println("Adding COS_SERVICE_INSTANCE_ID_DEFINED condition ...")
	return utilities.AppendCondition(ctx, controllerRuntimeClient, object, CONDITION_TYPE_COS_SERVICE_INSTANCE_ID_DEFINED, CONDITION_STATUS_FALSE,
...
func setConditionNamespaceDefined(ctx context.Context, controllerRuntimeClient client.Client, object client.Object) error {
	fmt.Println("Adding NAMESPACE_DEFINED condition ...")
	return utilities.AppendCondition(ctx, controllerRuntimeClient, object, CONDITION_TYPE_NAMESPACE_DEFINED, CONDITION_STATUS_FALSE,
...
func setConditionBackupResourceNameDefined(ctx context.Context, controllerRuntimeClient client.Client, object client.Object) error {
	fmt.Println("Adding BACKUP_RESOURCE_NAME_DEFINED condition ...")
	return utilities.AppendCondition(ctx, controllerRuntimeClient, object, CONDITION_TYPE_BACKUP_RESOURCE_NAME_DEFINED, CONDITION_STATUS_FALSE,
...
func setConditionDataRead(ctx context.Context, controllerRuntimeClient client.Client, object client.Object) error {
	fmt.Println("Adding DATA_READ condition ...")
	return utilities.AppendCondition(ctx, controllerRuntimeClient, object, CONDITION_TYPE_DATA_READ, CONDITION_STATUS_FALSE,
...
func setConditionDataWritten(ctx context.Context, controllerRuntimeClient client.Client, object client.Object) error {
	fmt.Println("Adding DATA_WRITTEN condition ...")
	return utilities.AppendCondition(ctx, controllerRuntimeClient, object, CONDITION_TYPE_DATA_WRITTEN, CONDITION_STATUS_FALSE,
...
func addConditionSucceeded(ctx context.Context, controllerRuntimeClient client.Client, object client.Object) error {
	fmt.Println("Adding SUCCEEDED condition ...")
	return utilities.AppendCondition(ctx, controllerRuntimeClient, object, CONDITION_TYPE_SUCCEEDED, CONDITION_STATUS_TRUE,
