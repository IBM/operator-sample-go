...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatabaseBackupCondition) DeepCopyInto(out *DatabaseBackupCondition) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DatabaseBackupCondition.
func (in *DatabaseBackupCondition) DeepCopy() *DatabaseBackupCondition {
	if in == nil {
		return nil
	}
	out := new(DatabaseBackupCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DatabaseBackupStatus) DeepCopyInto(out *DatabaseBackupStatus) {
	*out = *in
	if in.Conditions != nil {
		...
		*out = make([]DatabaseBackupCondition, len(*in))
		copy(*out, *in)
	}
	if in.Jobs != nil {
