...
func (reconciler *ApplicationReconciler) defineCronJob(application *applicationsamplev1beta1.Application) *batchv1.CronJob {
...
func (reconciler *ApplicationReconciler) reconcileCronJob(ctx context.Context, application *applicationsamplev1beta1.Application) (ctrl.Result, error) {
