...
* Create a Cloud Object Storage bucket for testing database backup [Setup Cloud Object Storage - link TODO](https://github.com/IBM/operator-sample-go/blob/cos-backup-documentation/documentation/cos.md)
* Create a secret with credentials for Cloud Object Storage [Setup COS Secret - link TODO](https://github.com/IBM/operator-sample-go/blob/cos-backup-documentation/documentation/cos.md)
