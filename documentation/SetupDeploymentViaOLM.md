...
```
$ make catalog-build docker-push CATALOG_IMG="$REGISTRY/$ORG/$IMAGE_APPLICATION_OPERATOR_CATALOG" BUNDLE_IMGS="$REGISTRY/$ORG/$IMAGE_APPLICATION_OPERATOR_BUNDLE" IMG="$REGISTRY/$ORG/$IMAGE_APPLICATION_OPERATOR_CATALOG"
```
